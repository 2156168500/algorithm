...
public class HorseJup {
    public static int  jup(int a ,int b,int k){
    ...
    public static int dp2(int a,int b,int k){
    ...
    public static void main(String[] args) {
        ...
        System.out.println(jup(x, y, step));
        System.out.println(dp2(x, y, step));
    }
}
